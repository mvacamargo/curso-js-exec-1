...
function render(input, out, __component, component, state) {
  ...
  out.w("<div class=\"container col-md-6 col-md-offset-3\"><div class=\"row\"><h3 class=\"padding-15\">Novo Usuário</h3></div><div class=\"row\"><form action=\"/usuario\" method=\"post\" class=\"col-md-12\"><div class=\"form-group\"><label for=\"nome\">Nome</label><input type=\"text\" class=\"form-control\" id=\"nome\" name=\"nome\" autofocus></div><div class=\"form-group\"><label for=\"email\">Email</label><input type=\"email\" class=\"form-control\" id=\"email\" name=\"email\"></div><div class=\"form-group\"><label for=\"login\">Login</label><input type=\"text\" class=\"form-control\" id=\"login\" name=\"login\"></div><div class=\"form-group\"><label for=\"senha\">Senha</label><input type=\"password\" class=\"form-control\" id=\"senha\" name=\"senha\"></div><button class=\"btn btn-lg btn-primary btn-block\" type=\"submit\">Cadastrar</button></form></div><div class=\"row\"><a href=\"/\" class=\"btn btn-lg btn-default btn-block\">Home</a></div></div>");
